...
const Navbar = () => {
  return (
    <nav className="navbar navbar-expand-lg px-md-4 px-3 py-3">
      <div className="container-fluid">
        ...
        <a className="navbar-brand text-white" href="#">
          <svg width="109" height="57" viewBox="0 0 109 57" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="10" y="35" fontSize="24" fill="white" fontWeight="bold">Grey</text>
            <defs>
        ...
        <div className="collapse navbar-collapse justify-content-center mt-3 mt-lg-0" id="navbarNav">
          <ul className="navbar-nav gap-lg-4 gap-3 text-center text-lg-start">
        ...
        {/* Connect Button (Visible only on large screens) */}
